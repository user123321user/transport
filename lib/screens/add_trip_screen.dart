  ...
  Widget build(BuildContext context) {
    return Directionality(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          title: const Text('تسجيل رحلة شاحنة جديدة', style: TextStyle(fontWeight: FontWeight.bold, color: Colors.white)),
          centerTitle: true,
          ...
          child: SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 12),
                if (_tripType == 'buy_sell') ...[
                  TextFormField(controller: _quarryController, decoration: const InputDecoration(labelText: 'اسم المقلع (المصدر)', border: OutlineInputBorder()), validator: (v) => v!.isEmpty ? 'مطلوب' : null),
                  const SizedBox(height: 12),
                ],
                TextFormField(controller: _customerController, decoration: const InputDecoration(labelText: 'اسم الزبون / التاجر المستلم', border: OutlineInputBorder()), validator: (v) => v!.isEmpty ? 'مطلوب' : null),
                const SizedBox(height: 12),
                TextFormField(controller: _materialController, decoration: const InputDecoration(labelText: 'نوع المادة (بحص، رمل...)', border: OutlineInputBorder())),
                const SizedBox(height: 16),
                const Divider(),
                const Text('الكميات والحسابات المالية', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16)),
                const SizedBox(height: 12),
                ...
                Center(
                  child: ElevatedButton(
                    ...
                    child: const Text('حفظ الرحلة وتحديث الأرصدة'),
                  ),
                )
              ],
            ),
