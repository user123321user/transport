...
class _SystemSetupScreenState extends State<SystemSetupScreen> with SingleTickerProviderStateMixin {
  ...
  String _accountCurrency = 'SYP'; // العملة المختارة الافتراضية للحساب المالي الجديد
  ...
  void _saveAccount() async {
    ...
    // استدعاء دالة الإدخال ثنائية العملة المحدثة في الداتابيز
    ...
    showDialog(
      ...
      builder: (ctx) => StatefulBuilder(
        builder: (context, setDialogState) => AlertDialog(
          title: const Text('تعديل حقول الحساب'),
              ...
              children: [
                ...
                DropdownButtonFormField<String>(
                  ...
                  items: const [
                    ...
                    DropdownMenuItem(value: 'quarry', child: Text('مقلع')),
  ...
  Widget build(BuildContext context) {
    return Directionality(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          title: const Text('ادارة الاليات والمستخدمين', style: TextStyle(fontWeight: FontWeight.bold, color: Colors.white)),
          centerTitle: true,
                  ...
                  children: [
                    ...
                    Expanded(
                      child: DropdownButtonFormField<String>(
                        ...
                        decoration: const InputDecoration(labelText: 'نوع العملة', border: OutlineInputBorder()),
                        items: const [
                          ...
                          child: ListTile(
                            ...
                            trailing: Row(
                              ...
                              children: [
                                IconButton(
                                  icon: const Icon(Icons.edit, color: Colors.blue),
                                  onPressed: () => _showEditAccountDialog(accId, item['name'], item['type'], item['is_permanent'] ?? 0, sypBal, usdBal),
                                ),
                                IconButton(
                                  icon: const Icon(Icons.delete, color: Colors.red),
                                  onPressed: () async {
