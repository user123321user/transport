...
class _SystemSetupScreenState extends State<SystemSetupScreen> with SingleTickerProviderStateMixin {
  ...
  void _saveTruck() async {
    ...
    ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text('تم حفظ الشاحنة بنجاح')));
    setState(() {});
  }
  ...
  Widget build(BuildContext context) {
    return Directionality(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          title: const Text('ادارة الحسابات والاليات', style: TextStyle(fontWeight: FontWeight.bold, color: Colors.white)),
          centerTitle: true,
          ...
          bottom: TabBar(
            ...
            tabs: const [
              Tab(icon: Icon(Icons.local_shipping), text: 'إدارة الاليات'),
    ...
    return Padding(
      ...
      child: Column(
        children: [
              ...
              child: Column(
                children: [
                  TextField(
                    ...
                    decoration: const InputDecoration(labelText: 'رقم الشاحنة', border: OutlineInputBorder()),
                  ...
                  ElevatedButton.icon(
                    ...
                    label: const Text('تسجيل الشاحنة'),
          ...
          const SizedBox(height: 20),
          const Align(alignment: Alignment.centerRight, child: Text(' الشاحنات المسجلة:', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16))),
            ...
            child: Column(
              children: [
                TextField(
                  ...
                  decoration: const InputDecoration(labelText: 'الاسم الكامل / الجهة التعاملية', border: OutlineInputBorder()),
                ),
                const SizedBox(height: 12),
                DropdownButtonFormField<String>(
                ...
                TextField(
                  ...
                  decoration: const InputDecoration(labelText: 'الرصيد الحالي في الشركة', border: OutlineInputBorder()),
                  keyboardType: TextInputType.number,
                ),
                const SizedBox(height: 8),
                SwitchListTile(
                  title: const Text('هل يملك حساب دائم في الشركة؟ (يسمح بالدين)'),
                ...
                const Align(
                  ...
                  child: Text('نسخ احتياطي لقاعدة البيانات', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 15, color: Colors.blueGrey)),
                ),
                const SizedBox(height: 12),
                ...
                ElevatedButton.icon(
                  ...
                  label: const Text('حفظ قاعدة البيانات'),
                  style: ElevatedButton.styleFrom(
                ...
                ElevatedButton.icon(
                  ...
                  label: const Text('استعادة قاعدة البيانات'),
                  style: ElevatedButton.styleFrom(
