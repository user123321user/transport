...
class _SystemSetupScreenState extends State<SystemSetupScreen> with SingleTickerProviderStateMixin {
  ...
  // واجهة تبويب الحسابات والعملاء المحدثة بالكامل بالأزرار اليدوية
          ...
          child: SingleChildScrollView(
            child: Column(
              children: [
                ...
                // ===== تم إضافة الأكواد هنا بدقة تحت الزر السابق مباشرة =====
                ...
                // زر تصدير النسخة الاحتياطية يدوياً
                ElevatedButton.icon(
                  onPressed: () async {
                ...
                // زر استعادة النسخة الاحتياطية يدوياً بعد إعادة التثبيت
                ElevatedButton.icon(
                  onPressed: () async {
