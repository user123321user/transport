  ...
  Widget build(BuildContext context) {
    return Directionality(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          title: const Text('كشف حساب السائقين', style: TextStyle(fontWeight: FontWeight.bold, color: Colors.white)),
          centerTitle: true,
                    ...
                    children: [
                      Expanded(
                        child: TextField(
                          ...
                          decoration: const InputDecoration(labelText: 'ااسم السائق', border: OutlineInputBorder()),
                        ),
                      ),
              ...
              if (_hasSearched) ...[
                Card(
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      children: [
                        Text('سجل مهمات السائق: ${_driverNameController.text}', style: const TextStyle(fontWeight: FontWeight.bold)),
                        const Divider(),
                        ...
                        Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [const Text('المصاريف المستلمة:'), Text('${_totalExpensesGiven.toStringAsFixed(0)} ل.س', style: const TextStyle(color: Colors.red, fontWeight: FontWeight.bold))]),
                      ],
                    ),
                  ),
                ),
                ...
                const Expanded(child: Center(child: Text('أدخل اسم السائق لعرض المعلومات')))
            ],
          ),
        ),
      ),
