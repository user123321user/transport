  ...
  Widget build(BuildContext context) {
    return Directionality(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          title: const Text('البحث المتقدم', style: TextStyle(fontWeight: FontWeight.bold, color: Colors.white)),
          centerTitle: true,
            ...
            children: [
              TextField(
                ...
                decoration: InputDecoration(
                  labelText: 'رقم الشاحنة، اسم السائق، المادة...',
              ...
              Expanded(
                child: _searchResults.isEmpty
                    ? const Center(child: Text('لا توجد نتائج مطابقة للبحث الحالي.'))
                    : ListView.builder(
