...
class _TripsListScreenState extends State<TripsListScreen> {
  ...
  Future<void> _captureAndSaveReceipt(int tripId) async {
    ...
    if (photo != null) {
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text('تم حفظ الإيصال')));
        setState(() {});
      }
    }
  }
  ...
  Widget build(BuildContext context) {
    return Directionality(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          title: const Text('الرحلات وإيصالات الوزن', style: TextStyle(fontWeight: FontWeight.bold, color: Colors.white)),
          centerTitle: true,
