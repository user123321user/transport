...
class _CashboxScreenState extends State<CashboxScreen> {
  ...
  void _saveTransaction() async {
    ...
    ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text('تم التسجيل في الصندوق بنجاح')));
    setState(() {});
  }
  ...
  Widget build(BuildContext context) {
    return Directionality(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          title: const Text('إدارة الصندوق', style: TextStyle(fontWeight: FontWeight.bold, color: Colors.white)),
          centerTitle: true,
            ...
            children: [
              ...
              Card(
                ...
                child: Padding(
                  ...
                  child: Column(
                    children: [
                      const Text('تسجيل عملية في الصندوق (قبض / صرف)', style: TextStyle(fontWeight: FontWeight.bold)),
                      const SizedBox(height: 10),
                      TextField(controller: _detailsController, decoration: const InputDecoration(labelText: 'التفاصيل', border: OutlineInputBorder())),
                      const SizedBox(height: 10),
                      TextField(controller: _amountController, decoration: const InputDecoration(labelText: 'المبلغ', border: OutlineInputBorder()), keyboardType: TextInputType.number),
                      Row(
              ...
              const SizedBox(height: 16),
              const Align(alignment: Alignment.centerRight, child: Text('سجل العمليات الأخيرة:', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16))),
              ...
              Expanded(
                child: FutureBuilder<List<Map<String, dynamic>>>(
                  ...
                  builder: (context, snapshot) {
                    ...
                    if (snapshot.data!.isEmpty) return const Center(child: Text('لا توجد عمليات مسجلة بعد.'));
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return Card(
                          child: ListTile(
                            ...
                            title: Text(item['details'] ?? 'بدون وصف'),
